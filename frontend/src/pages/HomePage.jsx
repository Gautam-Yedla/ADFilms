...
import NavigationButton from '../components/NavigationButton.jsx'; // Updated import
import { YoutubeIcon, WeddingIcon, CommercialsIcon } from '../constants.jsx'; // Updated import

const HomePage = () => { // Removed React.FC
  return (
    <div className="flex flex-col items-center justify-center py-8 sm:py-12">
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-700 mb-4 text-center">
        Welcome to <span className="text-rose-600">AD</span><span className="text-sky-600">FILMS</span>
      </h1>
      <p className="text-lg text-slate-600 mb-10 sm:mb-12 lg:mb-16 text-center max-w-2xl">
