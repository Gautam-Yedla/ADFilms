...
const categoriesData = [
  {
    ...
    description: 'Full cinematic coverage of your beautiful wedding day.'
  },
  {
    id: 2,
    title: 'Pre-Wedding Shoots',
    films: 2,
    imageUrl: 'https://images.unsplash.com/photo-1587899798970-b758faba00be?auto=format&fit=crop&w=600&q=80',
  ...
  },
  {
    ...
    description: 'Celebrate your special announcement with a memorable film.'
  },
  {
    id: 4,
    title: 'Sangeet',
    films: 3,
    imageUrl: 'https://images.unsplash.com/photo-1596963558090-3b760711602c?auto=format&fit=crop&w=600&q=80',
    description: 'Joyful dances and vibrant celebrations, beautifully captured.'
  },
  {
    id: 5,
    title: 'Haldi',
    films: 3,
    imageUrl: 'https://images.unsplash.com/photo-1604238898016-f73359100505?auto=format&fit=crop&w=600&q=80',
    description: 'The vibrant colors and emotions of your Haldi ceremony.'
  },
];
  ...
  return (
    <section id="wedding-portfolio" className="py-16 sm:py-24 bg-gray-100 dark:bg-neutral-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-playfair text-4xl sm:text-5xl font-bold text-gray-800 dark:text-white mb-3">
            Our Wedding Film Portfolio
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {categoriesData.map((category, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="font-playfair text-2xl font-semibold text-gray-800 dark:text-white mb-2">
                  {category.title}
                </h3>
                <p className="font-montserrat text-sm text-gray-600 dark:text-gray-300 mb-4 h-16 overflow-hidden">
