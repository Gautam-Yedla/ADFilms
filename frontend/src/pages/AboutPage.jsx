...
// const AboutPage = () => {
//   return (
//     <div className="min-h-screen bg-white dark:bg-zinc-900 text-zinc-800 dark:text-zinc-200 p-6 sm:p-10">
//       <div className="max-w-3xl mx-auto">
//         <h1 className="text-3xl font-bold mb-4">About AD Films</h1>
//         <p className="mb-4">
//           Welcome to AD Films! We are a dynamic team of creatives passionate about storytelling through film, visual design, and modern media. Our mission is to bring compelling stories to life, whether through commercials, short films, or full-scale productions.
//         </p>
//         <p className="mb-4">
//           With a commitment to quality, innovation, and authenticity, we strive to leave a lasting impression with every project. From pre-production to post-production, our team handles it all with professionalism and care.
//         </p>
//         <p>
//           Thank you for visiting us. We look forward to working with you on your next great story.
//         </p>
//       </div>
//     </div>
//   );
